...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/futuur_search_markets \
  -H 'Content-Type: application/json' \
  -d '{"search":"bitcoin price 2025"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/futuur_search_markets`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
